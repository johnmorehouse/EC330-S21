...
## Upcoming
  ...
  - .hi.slate[HW 1] (due on April 11th)
...
_Policies that impact the .hi.purple[spatial distribution] of the population can have far flung effects on individuals it was not designed to impact, .hi[via migration]_
...
- .hi.slate[Note]: We rested on
 ...
 - the implicit assumption that .pink[people are perfectly mobile] (and they are the same)
    ...
    - High skilled workers are generally far more mobile than low skilled (for a variety of reasons). Thoughts?

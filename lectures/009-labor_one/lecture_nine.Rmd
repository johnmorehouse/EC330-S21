...
- .hi.slate[HWII] due Friday `r emo::ji("warning")``r emo::ji("warning")``r emo::ji("warning")`
...
- __Midterm will be given next Monday (May 3rd)__

  - You must take it during class hours 

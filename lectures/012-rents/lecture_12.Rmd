...
3) .hi.purple[Cross-City Variation] 

4) .hi.purple[Two Policies]
...
We will focus on renters. But first let's take a look at some data
...
```{R, rent1, out.width = "70%", out.height = "65%", echo = F}
...
1) No individual landlord can influence the price of rents
...
- What causes rental curves to vary across cities? (both in intercept and slope)
